...
<div class="py-8">
  ...
  <p class="mb-8 text-lg text-gray-600">
    Aquí podrás gestionar la aplicación y ver estadísticas generales.
  </p>
  
  <!-- Tarjetas de estadísticas con enlaces -->
      ...
      <div class="bg-white shadow rounded-lg p-6 hover:shadow-xl transition duration-300">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-semibold text-gray-700">{{ $userCount ?? '0' }}</p>
          </div>
        </div>
      </div>
    </a>
      ...
      <div class="bg-white shadow rounded-lg p-6 hover:shadow-xl transition duration-300">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-semibold text-gray-700">{{ $salesCount ?? '0' }}</p>
          </div>
        </div>
      </div>
    </a>
      ...
      <div class="bg-white shadow rounded-lg p-6 hover:shadow-xl transition duration-300">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-semibold text-gray-700">{{ $productCount ?? '0' }}</p>
          </div>
        </div>
      </div>
    </a>
      ...
      <div class="bg-white shadow rounded-lg p-6 hover:shadow-xl transition duration-300">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-semibold text-gray-700">{{ $categoryCount ?? '0' }}</p>
          </div>
        </div>
      </div>
    </a>
            ...
            @forelse($latestSales as $sale)
              <tr>
                ...
                <td class="px-4 py-2 whitespace-nowrap text-center">
                  <a href="{{ route('admin.sales.show', $sale) }}" class="text-blue-500 hover:text-blue-700" title="Ver Detalles">
